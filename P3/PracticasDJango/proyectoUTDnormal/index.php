...
if (isset($_SESSION['username'])) {
    $mensajee = "Bienvenido a mi proyceto, haz iniciado sesión correctamente";
...
<body>
    ...
    <nav>
        <ul>
            ...
            <?php if (isset($_SESSION['username'])): ?>
                ...
                <li><a href="html/about.php">Acerca de</a></li>
    ...
    <footer>
        <p>PHP con MarLine &copy; 2024 | Visitado el: 01/10/24</p>
    </footer>
</body>
</html>